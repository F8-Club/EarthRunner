...
$(function() {
	    ...
	    var buffer = new Array(maxBufferSize); // ring buffer with next few frames
	    ...
	    function loadFrameInBuffer(fi, bi) {
	    	buffer[bi] = {};
	    	buffer[bi].heading = headingToNext(fi);
	    	buffer[bi].distance = distanceToNext(fi);
...
//	    			alert("from: " + from + ", to " + to + ", f: " + f + " = " + newPoint);
	    ...
	    function updateStatus() {
    		...
    		var r1 = "distance to next point: <b>" + buffer[bufferStart].distance + "</b> m ";
    		var r2 = "<br>coord: <b>" + p + "</b>" ;
    		var r3 = "<br>speed: <b>" + speed + "</b>";
    		var r4 = "<br>buffer size: <b>" + bufferSize().toString() + "</b>";
    		var r5 = "<br>buffer idx: <b>" + bufferStart.toString() + "</b>" 
    		var r6 = "<br>traveled: <b>" + traveled.toString() + "</b>";
    		$("#distance").html( r1+r2+r3+r4+r5+r6);
